        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-800">
                    ...
                    <button class="my-3 mx-1 bg-green-400 hover:bg-green-500 focus:ring-2 focus:outline-none focus:ring-green-600 rounded-lg text-sm px-4 py-2 dark:bg-green-500 dark:hover:bg-green-300 dark:focus:ring-green-300"><a href="{{ route("proveedores.create") }}">Nuevo proveedor</a></button>
                    
                    @if(count($proveedores)<=0)

                        <div class="font-bold text-center align-middle w-full">
                            <div class="border-y-2 border-y-blue-300"> No se han encontrado Proveedores con la búsqueda "{{ $buscar }}"</div>
                        </div>
